...
import { useAgentSessionSse } from "./useAgentSession-sse";
import {
...
export function useAgentSession(opts: UseAgentSessionOptions) {
  ...
  // SSE-streaming core lives in useAgentSession-sse (extraction only — the
  // destructured names keep every call site below unchanged).
  const {
    eventSourceRef,
    reconnectTimerRef,
    reconnectActionsRef,
